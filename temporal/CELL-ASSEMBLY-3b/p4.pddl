(DEFINE (PROBLEM CELL-ASSEMBLY-MODEL3B-4)
 ...
 (:INIT
  ...
  (= (LOADING-COST) 1)
  ;; (= (TOTAL-TIME) 0)
  (FINISHED NOTHING-DONE BASE0-7321)
  (FINISHED NOTHING-DONE BASE1-7320)
  (FINISHED NOTHING-DONE BASE2-7319)
  (FINISHED NOTHING-DONE BASE3-7318)
  (AT BASE0-7321 CARRY-IN)
  (AT BASE1-7320 CARRY-IN)
  (AT BASE2-7319 CARRY-IN)
  (AT BASE3-7318 CARRY-IN))
 (:GOAL
  (AND (FINISHED J8 BASE0-7321)
       (FINISHED J8 BASE1-7320)
       (FINISHED J8 BASE2-7319)
       (FINISHED J8 BASE3-7318)
       (AT BASE0-7321 CARRY-OUT)
       (AT BASE1-7320 CARRY-OUT)
       (AT BASE2-7319 CARRY-OUT)
       (AT BASE3-7318 CARRY-OUT)))
