(DEFINE (PROBLEM CELL-ASSEMBLY-MODEL2B-4)
  ...
  (:INIT
   ...
   (= (LOADING-COST) 1)
   ;; (= (TOTAL-TIME) 0)
   (FINISHED NOTHING-DONE BASE0-1558)
   (FINISHED NOTHING-DONE BASE1-1557)
   (FINISHED NOTHING-DONE BASE2-1556)
   (FINISHED NOTHING-DONE BASE3-1555)
   (AT BASE0-1558 CARRY-IN)
   (AT BASE1-1557 CARRY-IN)
   (AT BASE2-1556 CARRY-IN)
   (AT BASE3-1555 CARRY-IN))
  (:GOAL
   (AND (FINISHED SCREW-C BASE0-1558)
        (FINISHED SCREW-C BASE1-1557)
        (FINISHED SCREW-C BASE2-1556)
        (FINISHED SCREW-C BASE3-1555)
        (AT BASE0-1558 CARRY-OUT)
        (AT BASE1-1557 CARRY-OUT)
        (AT BASE2-1556 CARRY-OUT)
        (AT BASE3-1555 CARRY-OUT)))
