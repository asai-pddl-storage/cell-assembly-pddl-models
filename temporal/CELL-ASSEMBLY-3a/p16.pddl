(DEFINE (PROBLEM CELL-ASSEMBLY-MODEL3A-16)
...
(NOT-ARM-PRESENT m1)
  ...
  (= (LOADING-COST) 1)
  ;; (= (TOTAL-TIME) 0)
  (FINISHED NOTHING-DONE BASE0-5265)
  (FINISHED NOTHING-DONE BASE1-5264)
  (FINISHED NOTHING-DONE BASE2-5263)
  (FINISHED NOTHING-DONE BASE3-5262)
  (FINISHED NOTHING-DONE BASE4-5261)
  (FINISHED NOTHING-DONE BASE5-5260)
  (FINISHED NOTHING-DONE BASE6-5259)
  (FINISHED NOTHING-DONE BASE7-5258)
  (FINISHED NOTHING-DONE BASE8-5257)
  (FINISHED NOTHING-DONE BASE9-5256)
  (FINISHED NOTHING-DONE BASE10-5255)
  (FINISHED NOTHING-DONE BASE11-5254)
  (FINISHED NOTHING-DONE BASE12-5253)
  (FINISHED NOTHING-DONE BASE13-5252)
  (FINISHED NOTHING-DONE BASE14-5251)
  (FINISHED NOTHING-DONE BASE15-5250)
  (AT BASE0-5265 CARRY-IN)
  (AT BASE1-5264 CARRY-IN)
  (AT BASE2-5263 CARRY-IN)
  (AT BASE3-5262 CARRY-IN)
  (AT BASE4-5261 CARRY-IN)
  (AT BASE5-5260 CARRY-IN)
  (AT BASE6-5259 CARRY-IN)
  (AT BASE7-5258 CARRY-IN)
  (AT BASE8-5257 CARRY-IN)
  (AT BASE9-5256 CARRY-IN)
  (AT BASE10-5255 CARRY-IN)
  (AT BASE11-5254 CARRY-IN)
  (AT BASE12-5253 CARRY-IN)
  (AT BASE13-5252 CARRY-IN)
  (AT BASE14-5251 CARRY-IN)
  (AT BASE15-5250 CARRY-IN))
 (:GOAL
  (AND (FINISHED J9 BASE0-5265)
       (FINISHED J9 BASE1-5264)
       (FINISHED J9 BASE2-5263)
       (FINISHED J9 BASE3-5262)
       (FINISHED J9 BASE4-5261)
       (FINISHED J9 BASE5-5260)
       (FINISHED J9 BASE6-5259)
       (FINISHED J9 BASE7-5258)
       (FINISHED J9 BASE8-5257)
       (FINISHED J9 BASE9-5256)
       (FINISHED J9 BASE10-5255)
       (FINISHED J9 BASE11-5254)
       (FINISHED J9 BASE12-5253)
       (FINISHED J9 BASE13-5252)
       (FINISHED J9 BASE14-5251)
       (FINISHED J9 BASE15-5250)
       (AT BASE0-5265 CARRY-OUT)
       (AT BASE1-5264 CARRY-OUT)
       (AT BASE2-5263 CARRY-OUT)
       (AT BASE3-5262 CARRY-OUT)
       (AT BASE4-5261 CARRY-OUT)
       (AT BASE5-5260 CARRY-OUT)
       (AT BASE6-5259 CARRY-OUT)
       (AT BASE7-5258 CARRY-OUT)
       (AT BASE8-5257 CARRY-OUT)
       (AT BASE9-5256 CARRY-OUT)
       (AT BASE10-5255 CARRY-OUT)
       (AT BASE11-5254 CARRY-OUT)
       (AT BASE12-5253 CARRY-OUT)
       (AT BASE13-5252 CARRY-OUT)
       (AT BASE14-5251 CARRY-OUT)
       (AT BASE15-5250 CARRY-OUT)))
