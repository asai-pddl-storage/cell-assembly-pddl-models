(DEFINE (PROBLEM CELL-ASSEMBLY-MODEL3C-4)
 ...
 (:INIT
  ...
  (= (LOADING-COST) 1)
  ;; (= (TOTAL-TIME) 0)
  (FINISHED NOTHING-DONE BASE0-9350)
  (FINISHED NOTHING-DONE BASE1-9349)
  (FINISHED NOTHING-DONE BASE2-9348)
  (FINISHED NOTHING-DONE BASE3-9347)
  (AT BASE0-9350 CARRY-IN)
  (AT BASE1-9349 CARRY-IN)
  (AT BASE2-9348 CARRY-IN)
  (AT BASE3-9347 CARRY-IN))
 (:GOAL
  (AND (FINISHED MJ5 BASE0-9350)
       (FINISHED MJ5 BASE1-9349)
       (FINISHED MJ5 BASE2-9348)
       (FINISHED MJ5 BASE3-9347)
       (AT BASE0-9350 CARRY-OUT)
       (AT BASE1-9349 CARRY-OUT)
       (AT BASE2-9348 CARRY-OUT)
       (AT BASE3-9347 CARRY-OUT)))
