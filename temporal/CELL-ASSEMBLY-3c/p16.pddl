(DEFINE (PROBLEM CELL-ASSEMBLY-MODEL3C-16)
 ...
 (:INIT
  ...
  (= (LOADING-COST) 1)
  ;; (= (TOTAL-TIME) 0)
  (FINISHED NOTHING-DONE BASE0-9563)
  (FINISHED NOTHING-DONE BASE1-9562)
  (FINISHED NOTHING-DONE BASE2-9561)
  (FINISHED NOTHING-DONE BASE3-9560)
  (FINISHED NOTHING-DONE BASE4-9559)
  (FINISHED NOTHING-DONE BASE5-9558)
  (FINISHED NOTHING-DONE BASE6-9557)
  (FINISHED NOTHING-DONE BASE7-9556)
  (FINISHED NOTHING-DONE BASE8-9555)
  (FINISHED NOTHING-DONE BASE9-9554)
  (FINISHED NOTHING-DONE BASE10-9553)
  (FINISHED NOTHING-DONE BASE11-9552)
  (FINISHED NOTHING-DONE BASE12-9551)
  (FINISHED NOTHING-DONE BASE13-9550)
  (FINISHED NOTHING-DONE BASE14-9549)
  (FINISHED NOTHING-DONE BASE15-9548)
  (AT BASE0-9563 CARRY-IN)
  (AT BASE1-9562 CARRY-IN)
  (AT BASE2-9561 CARRY-IN)
  (AT BASE3-9560 CARRY-IN)
  (AT BASE4-9559 CARRY-IN)
  (AT BASE5-9558 CARRY-IN)
  (AT BASE6-9557 CARRY-IN)
  (AT BASE7-9556 CARRY-IN)
  (AT BASE8-9555 CARRY-IN)
  (AT BASE9-9554 CARRY-IN)
  (AT BASE10-9553 CARRY-IN)
  (AT BASE11-9552 CARRY-IN)
  (AT BASE12-9551 CARRY-IN)
  (AT BASE13-9550 CARRY-IN)
  (AT BASE14-9549 CARRY-IN)
  (AT BASE15-9548 CARRY-IN))
 (:GOAL
  (AND (FINISHED MJ5 BASE0-9563)
       (FINISHED MJ5 BASE1-9562)
       (FINISHED MJ5 BASE2-9561)
       (FINISHED MJ5 BASE3-9560)
       (FINISHED MJ5 BASE4-9559)
       (FINISHED MJ5 BASE5-9558)
       (FINISHED MJ5 BASE6-9557)
       (FINISHED MJ5 BASE7-9556)
       (FINISHED MJ5 BASE8-9555)
       (FINISHED MJ5 BASE9-9554)
       (FINISHED MJ5 BASE10-9553)
       (FINISHED MJ5 BASE11-9552)
       (FINISHED MJ5 BASE12-9551)
       (FINISHED MJ5 BASE13-9550)
       (FINISHED MJ5 BASE14-9549)
       (FINISHED MJ5 BASE15-9548)
       (AT BASE0-9563 CARRY-OUT)
       (AT BASE1-9562 CARRY-OUT)
       (AT BASE2-9561 CARRY-OUT)
       (AT BASE3-9560 CARRY-OUT)
       (AT BASE4-9559 CARRY-OUT)
       (AT BASE5-9558 CARRY-OUT)
       (AT BASE6-9557 CARRY-OUT)
       (AT BASE7-9556 CARRY-OUT)
       (AT BASE8-9555 CARRY-OUT)
       (AT BASE9-9554 CARRY-OUT)
       (AT BASE10-9553 CARRY-OUT)
       (AT BASE11-9552 CARRY-OUT)
       (AT BASE12-9551 CARRY-OUT)
       (AT BASE13-9550 CARRY-OUT)
       (AT BASE14-9549 CARRY-OUT)
       (AT BASE15-9548 CARRY-OUT)))
