(DEFINE (PROBLEM CELL-ASSEMBLY-MODEL2A-4)
 ...
 (:INIT
  ...
  (= (LOADING-COST) 1)
  (FINISHED NOTHING-DONE BASE0-3103)
  (FINISHED NOTHING-DONE BASE1-3102)
  (FINISHED NOTHING-DONE BASE2-3101)
  (FINISHED NOTHING-DONE BASE3-3100)
  (AT BASE0-3103 CARRY-IN)
  (AT BASE1-3102 CARRY-IN)
  (AT BASE2-3101 CARRY-IN)
  (AT BASE3-3100 CARRY-IN))
 (:GOAL
  (AND (FINISHED INSPECT-BASE BASE0-3103)
       (FINISHED INSPECT-BASE BASE1-3102)
       (FINISHED INSPECT-BASE BASE2-3101)
       (FINISHED INSPECT-BASE BASE3-3100)
       (AT BASE0-3103 CARRY-OUT)
       (AT BASE1-3102 CARRY-OUT)
       (AT BASE2-3101 CARRY-OUT)
       (AT BASE3-3100 CARRY-OUT)))
