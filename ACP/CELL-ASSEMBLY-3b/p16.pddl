(DEFINE (PROBLEM CELL-ASSEMBLY-MODEL3B-16)
 ...
 (:INIT
  ...
  (= (LOADING-COST) 1)
  (= (TOTAL-COST) 0)
  (FINISHED NOTHING-DONE BASE0-2163)
  (FINISHED NOTHING-DONE BASE1-2162)
  (FINISHED NOTHING-DONE BASE2-2161)
  (FINISHED NOTHING-DONE BASE3-2160)
  (FINISHED NOTHING-DONE BASE4-2159)
  (FINISHED NOTHING-DONE BASE5-2158)
  (FINISHED NOTHING-DONE BASE6-2157)
  (FINISHED NOTHING-DONE BASE7-2156)
  (FINISHED NOTHING-DONE BASE8-2155)
  (FINISHED NOTHING-DONE BASE9-2154)
  (FINISHED NOTHING-DONE BASE10-2153)
  (FINISHED NOTHING-DONE BASE11-2152)
  (FINISHED NOTHING-DONE BASE12-2151)
  (FINISHED NOTHING-DONE BASE13-2150)
  (FINISHED NOTHING-DONE BASE14-2149)
  (FINISHED NOTHING-DONE BASE15-2148)
  (AT BASE0-2163 CARRY-IN)
  (AT BASE1-2162 CARRY-IN)
  (AT BASE2-2161 CARRY-IN)
  (AT BASE3-2160 CARRY-IN)
  (AT BASE4-2159 CARRY-IN)
  (AT BASE5-2158 CARRY-IN)
  (AT BASE6-2157 CARRY-IN)
  (AT BASE7-2156 CARRY-IN)
  (AT BASE8-2155 CARRY-IN)
  (AT BASE9-2154 CARRY-IN)
  (AT BASE10-2153 CARRY-IN)
  (AT BASE11-2152 CARRY-IN)
  (AT BASE12-2151 CARRY-IN)
  (AT BASE13-2150 CARRY-IN)
  (AT BASE14-2149 CARRY-IN)
  (AT BASE15-2148 CARRY-IN))
 (:GOAL
  (AND (FINISHED J8 BASE0-2163)
       (FINISHED J8 BASE1-2162)
       (FINISHED J8 BASE2-2161)
       (FINISHED J8 BASE3-2160)
       (FINISHED J8 BASE4-2159)
       (FINISHED J8 BASE5-2158)
       (FINISHED J8 BASE6-2157)
       (FINISHED J8 BASE7-2156)
       (FINISHED J8 BASE8-2155)
       (FINISHED J8 BASE9-2154)
       (FINISHED J8 BASE10-2153)
       (FINISHED J8 BASE11-2152)
       (FINISHED J8 BASE12-2151)
       (FINISHED J8 BASE13-2150)
       (FINISHED J8 BASE14-2149)
       (FINISHED J8 BASE15-2148)
       (AT BASE0-2163 CARRY-OUT)
       (AT BASE1-2162 CARRY-OUT)
       (AT BASE2-2161 CARRY-OUT)
       (AT BASE3-2160 CARRY-OUT)
       (AT BASE4-2159 CARRY-OUT)
       (AT BASE5-2158 CARRY-OUT)
       (AT BASE6-2157 CARRY-OUT)
       (AT BASE7-2156 CARRY-OUT)
       (AT BASE8-2155 CARRY-OUT)
       (AT BASE9-2154 CARRY-OUT)
       (AT BASE10-2153 CARRY-OUT)
       (AT BASE11-2152 CARRY-OUT)
       (AT BASE12-2151 CARRY-OUT)
       (AT BASE13-2150 CARRY-OUT)
       (AT BASE14-2149 CARRY-OUT)
       (AT BASE15-2148 CARRY-OUT)))
