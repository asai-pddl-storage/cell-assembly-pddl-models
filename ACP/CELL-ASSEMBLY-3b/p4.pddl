(DEFINE (PROBLEM CELL-ASSEMBLY-MODEL3B-4)
 ...
 (:INIT
  ...
  (= (LOADING-COST) 1)
  (= (TOTAL-COST) 0)
  (FINISHED NOTHING-DONE BASE0-1817)
  (FINISHED NOTHING-DONE BASE1-1816)
  (FINISHED NOTHING-DONE BASE2-1815)
  (FINISHED NOTHING-DONE BASE3-1814)
  (AT BASE0-1817 CARRY-IN)
  (AT BASE1-1816 CARRY-IN)
  (AT BASE2-1815 CARRY-IN)
  (AT BASE3-1814 CARRY-IN))
 (:GOAL
  (AND (FINISHED J8 BASE0-1817)
       (FINISHED J8 BASE1-1816)
       (FINISHED J8 BASE2-1815)
       (FINISHED J8 BASE3-1814)
       (AT BASE0-1817 CARRY-OUT)
       (AT BASE1-1816 CARRY-OUT)
       (AT BASE2-1815 CARRY-OUT)
       (AT BASE3-1814 CARRY-OUT)))
