(DEFINE (PROBLEM CELL-ASSEMBLY-MODEL3C-4)
 ...
 (:INIT
  ...
  (= (LOADING-COST) 1)
  (= (TOTAL-COST) 0)
  (FINISHED NOTHING-DONE BASE0-1797)
  (FINISHED NOTHING-DONE BASE1-1796)
  (FINISHED NOTHING-DONE BASE2-1795)
  (FINISHED NOTHING-DONE BASE3-1794)
  (AT BASE0-1797 CARRY-IN)
  (AT BASE1-1796 CARRY-IN)
  (AT BASE2-1795 CARRY-IN)
  (AT BASE3-1794 CARRY-IN))
 (:GOAL
  (AND (FINISHED MJ5 BASE0-1797)
       (FINISHED MJ5 BASE1-1796)
       (FINISHED MJ5 BASE2-1795)
       (FINISHED MJ5 BASE3-1794)
       (AT BASE0-1797 CARRY-OUT)
       (AT BASE1-1796 CARRY-OUT)
       (AT BASE2-1795 CARRY-OUT)
       (AT BASE3-1794 CARRY-OUT)))
