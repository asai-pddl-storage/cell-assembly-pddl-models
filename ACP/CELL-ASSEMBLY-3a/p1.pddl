(DEFINE (PROBLEM CELL-ASSEMBLY-MODEL3A-1) (:DOMAIN CELL-ASSEMBLY)
 (:OBJECTS A1 A2 A3 - ARM B-0 - BASE P1 P2 P3 - COMPONENT T1 T2 T3 - TRAY
 ...
 (:INIT (= (TOTAL-COST) 0) (= (LOADING-COST) 1) (REACHABLE A1 TABLE-IN)
  ...
  (DEPENDS J3 J4) (JOB-AVAILABLE-AT J4 M3) (= (JOB-COST J3) 3) (DEPENDS J2 J3)
  (JOB-AVAILABLE-AT J3 M2) (AT P1 T1) (USES J2 P1) (= (JOB-COST J2) 3)
 ...
 (:GOAL (AND (AT B-0 CARRY-OUT) (FINISHED J9 B-0)))
