(DEFINE (PROBLEM CELL-ASSEMBLY-MODEL3A-4)
 ...
 (:INIT
  ...
  (= (LOADING-COST) 1)
  (= (TOTAL-COST) 0)
  (FINISHED NOTHING-DONE BASE0-1696)
  (FINISHED NOTHING-DONE BASE1-1695)
  (FINISHED NOTHING-DONE BASE2-1694)
  (FINISHED NOTHING-DONE BASE3-1693)
  (AT BASE0-1696 CARRY-IN)
  (AT BASE1-1695 CARRY-IN)
  (AT BASE2-1694 CARRY-IN)
  (AT BASE3-1693 CARRY-IN))
 (:GOAL
  (AND (FINISHED J9 BASE0-1696)
       (FINISHED J9 BASE1-1695)
       (FINISHED J9 BASE2-1694)
       (FINISHED J9 BASE3-1693)
       (AT BASE0-1696 CARRY-OUT)
       (AT BASE1-1695 CARRY-OUT)
       (AT BASE2-1694 CARRY-OUT)
       (AT BASE3-1693 CARRY-OUT)))
